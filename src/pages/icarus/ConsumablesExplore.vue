...
export default {
    ...
    computed: {
        ...
        ...mapGetters(useIcarusStore, ['foodBuffStatOptions', 'planningTabs', 'pageLayout']),
        ...
        tableScrollX() {
            const fixed = 200 + 120 + 70 + 80 + 80 + 90 + 260 + 140;
            ...
            const baseColumns = [
                {
                    ...
                    render: (row) => {
                        ...
                        const nameNode = h(
                            'span',
                            {
                                class: tip ? 'food-name food-name--hoverable table-name-label' : 'food-name table-name-label',
                                title: row.label,
                            },
                            row.label
                        );
                        ...
                        return h('div', { class: 'food-name-row' }, [
                            labeled,
